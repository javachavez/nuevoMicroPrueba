...
@RestController
@RequestMapping("/api/nuevo-micro-prueba-kafka")
public class NuevoMicroPruebaKafkaResource {
    private final Logger log = LoggerFactory.getLogger(NuevoMicroPruebaKafkaResource.class);

    private final KafkaProperties kafkaProperties;
    private KafkaProducer<String, String> producer;
    private ExecutorService sseExecutorService = Executors.newCachedThreadPool();

    public NuevoMicroPruebaKafkaResource(KafkaProperties kafkaProperties) {
